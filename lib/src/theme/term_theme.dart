...
class TermareStyles {
  ...
  static TermareStyle manjaro = TermareStyle(
    ...
    lightRed: const Color(0xffaa0000),
    green: const Color(0xff00aa00),
    lightGreen: const Color(0xff00aa00),
    yellow: const Color(0xffaa5500),
    lightYellow: const Color(0xffaa5500),
    blue: const Color(0xff0000aa),
    lightBlue: const Color(0xff0000aa),
    purplishRed: const Color(0xffaa00aa),
    lightPurplishRed: const Color(0xffaa00aa),
